...
lib LibRaylib
  ...
  fun is_file_extension? = IsFileExtension(file_name : LibC::Char*, ext : LibC::Char*) : Bool
  ...
  fun is_key_pressed? = IsKeyPressed(key : LibC::Int) : Bool
  fun is_key_down? = IsKeyDown(key : LibC::Int) : Bool
  fun is_key_released? = IsKeyReleased(key : LibC::Int) : Bool
  fun is_key_up? = IsKeyUp(key : LibC::Int) : Bool
  ...
  fun is_gamepad_available? = IsGamepadAvailable(gamepad : LibC::Int) : Bool
  fun get_gamepad_name = GetGamepadName(gamepad : LibC::Int) : LibC::Char*
  fun is_gamepad_button_pressed? = IsGamepadButtonPressed(gamepad : LibC::Int, button : LibC::Int) : Bool
  fun is_gamepad_button_down? = IsGamepadButtonDown(gamepad : LibC::Int, button : LibC::Int) : Bool
  fun is_gamepad_button_released? = IsGamepadButtonReleased(gamepad : LibC::Int, button : LibC::Int) : Bool
  fun is_gamepad_button_up? = IsGamepadButtonUp(gamepad : LibC::Int, button : LibC::Int) : Bool
  ...
  fun is_mouse_button_pressed? = IsMouseButtonPressed(button : LibC::Int) : Bool
  fun is_mouse_button_down? = IsMouseButtonDown(button : LibC::Int) : Bool
  fun is_mouse_button_released? = IsMouseButtonReleased(button : LibC::Int) : Bool
  fun is_mouse_button_up? = IsMouseButtonUp(button : LibC::Int) : Bool
  ...
  fun is_gesture_detected? = IsGestureDetected(gesture : LibC::Int) : Bool
