...
lib LibRaylib
  ...
  struct PhysicsManifoldData 
    ...
    normal : Vector2
    contacts : StaticArray(Vector2, 2)
  ...
  fun create_physics_body_circle = CreatePhysicsBodyCircle(pos : Vector2, radius : LibC::Float, density : LibC::Float) : PhysicsBody
  fun create_physics_body_rectangle = CreatePhysicsBodyRectangle(pos : Vector2, width : LibC::Float, height : LibC::Float, density : LibC::Float) : PhysicsBody
  fun create_physics_body_polygon = CreatePhysicsBodyPolygon(pos : Vector2, sides : LibC::Int, density : LibC::Float) : PhysicsBody
